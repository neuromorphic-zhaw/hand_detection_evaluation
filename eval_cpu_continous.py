...
if __name__ == '__main__':      
    ...
    system = 'cpu_continous_4080frames'
    ...
    step_counter_max = len(complete_dataset)
    ...
    sender = io.injector.Injector(shape=net.inp.shape, buffer_size=step_counter_max+8)
    ...
    receiver = io.extractor.Extractor(shape=net.out.shape, buffer_size=step_counter_max+8)
    ...
    encoder_output_extractor = io.extractor.Extractor(shape=net.inp.shape, buffer_size=step_counter_max+8)
